...
HYDRA_FULL_ERROR=1 torchrun \
  ...
  use_bf16=True \
  use_amp=True \
  resume_checkpoint_path="/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/public/yjc/cunxin/pi0_suite/open-pi-zero/logs/train/bridge_train_tp4_beta/2025-03-14_20-06_42/checkpoint/step19669.pt" \
  resume_checkpoint_step=False

# cd /inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/public/yjc/cunxin/occupy_gpu
