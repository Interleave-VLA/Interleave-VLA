...
# RAW_DATA_PATH = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/public/yjc/cunxin/Chameleon-VLA/baseline/scripts/data_generation/vima_dataset/*/"
RAW_DATA_PATH = "/inspire/ssd/ws-f4d69b29-e0a5-44e6-bd92-acf4de9990f0/public-project/public/yjc/sunyihang/Chameleon-VLA/vima_dataset_se2/scene_understanding/"
...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path):
        ...
        for i, step in enumerate(data):
            ...
            assert state2.shape[-1] == 8, f"Action shape should be [x, y, z, x, y, z, w, gripper]" #
